...
try { BroadcastsController::processPending($migrationsDb); } catch (\Throwable $e) {}
...
$router->put('/api/crm/leads/:id/alias', [CRMController::class, 'updateAlias'], [$auth]);
...
$router->post('/api/crm/tags', [CRMController::class, 'createTag'], [$auth]);
...
$router->post('/api/broadcasts/lists/:id/contacts', [BroadcastsController::class, 'addContacts'], [$auth]);
