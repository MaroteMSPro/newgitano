  ...
  <div class="est-page">
    <div class="page-header">
      ...
      <div class="header-actions">
        <div class="date-range">
          <input type="date" v-model="desde" :max="hoy" @change="load" class="date-input" />
          <span>→</span>
          <input type="date" v-model="hasta" :max="hoy" @change="load" class="date-input" />
        </div>
    ...
    <template v-else-if="kpi">
      ...
      <div class="section">
        ...
        <div class="tabla-wrapper">
          <table class="tabla">
            <thead>
              <tr>
                <th>Vendedor</th><th>Leads (periodo)</th><th>Leads total</th><th>Cerrados ✅</th><th>Cerrados ❌</th>
            ...
            <tbody>
              <tr v-for="v in vendedores" :key="v.id">
                ...
                <td><strong>{{ v.leads_total }}</strong></td>
              ...
              <tr v-if="!vendedores.length">
                <td colspan="9" class="empty-row">Sin datos en el período</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div v-if="topInstancias.length" class="section">
        ...
        <div class="tabla-wrapper">
          <table class="tabla">
            <thead><tr><th>Instancia</th><th>Leads</th><th>Msgs enviados</th><th>Msgs recibidos</th></tr></thead>
            <tbody>
